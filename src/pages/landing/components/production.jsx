...
const steps = [
  {
    id: 1,
    icon: <Calculator className="text-6xl text-orange-500" />,
  ...
  {
    id: 3,
    icon: <Truck className="text-6xl text-orange-500" />,
        ...
        {steps.map((step) => (
          <div key={step.id} className="flex flex-col items-center">
            <div className="relative flex items-center justify-center bg-white shadow-lg rounded-full p-6 mb-4">
              {step.icon}
              <span className="absolute top-0 right-0 bg-orange-500 text-white rounded-full px-2 py-1 text-xs">{step.id}</span>
            </div>
